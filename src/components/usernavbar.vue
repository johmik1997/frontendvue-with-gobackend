        ...
        <div class="auth-dropdown">
          ...
          <transition name="fade">
            <div v-if="showDropdown" class="dropdown-menu" v-click-outside="closeDropdown">
              <RouterLink to="/profile" class="dropdown-item" @click="closeDropdown">Profile</RouterLink>
              <RouterLink to="/logout" class="dropdown-item" @click="closeDropdown">Logout</RouterLink>
            </div>
          </transition>
        </div>
      </div>
